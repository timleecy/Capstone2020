# -*- coding: utf-8 -*-
"""
Created on Sun Aug 23 12:09:19 2020
...
while True:
    ...
    if target_shape == 'circle':
        ...
        circles = cv.HoughCircles(mask,cv.HOUGH_GRADIENT,1,500,
        ...
        if circles is not None:
            ...
            for i in circles[0,:]:      
                ...
                if found:
                    ...
                    objects = np.append(objects, area) #change area to actual size
                    found = False
        ...
        for cnt in contours: 
            ...
            if area > 20000:  #stick to 3000 for now
                approx = cv.approxPolyDP(cnt,  
                                     0.01 * cv.arcLength(cnt, True), True) #dont change 0.05
