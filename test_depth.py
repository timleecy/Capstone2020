# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 16:24:38 2020
...
import depth_image_encoding as die
...
while True:
    ...
    #res_row = (2*depth*np.tan((58.5*np.pi/180)/2))/depth.shape[1]
    #res_col = (2*depth*np.tan((45.6*np.pi/180)/2))/depth.shape[0]
    ...
    #next_depth_name = next_image_name[0:13] + '03.png'
